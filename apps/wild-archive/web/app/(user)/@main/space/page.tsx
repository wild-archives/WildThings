...
const Space = () => {
  const userProfile = {
    ...
    socialLinks: [
      ...
      { platform: 'Bilibili', url: 'https://space.bilibili.com/maxtunelee', icon: SiBilibili }
    ]
  };
        ...
        <div className="flex flex-col md:flex-row gap-8 items-start md:pl-40">
          <div className="flex-1">
            ...
            <div className="flex gap-6 mb-4">
              <span><strong>{userProfile.posts}</strong> 个 Archive</span>
              <span><strong>{userProfile.followers}</strong> 已关注</span>
              <span><strong>{userProfile.following}</strong> 粉丝</span>
            </div>
